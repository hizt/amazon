 ...
 */
 ...
 class GetFulfillmentOrderResult extends Model {
    ...
    {
    $this->_fields = array (
    'FulfillmentOrder' => array('FieldValue' => null, 'FieldType' => FulfillmentOrder::className()),
    'FulfillmentOrderItem' => array('FieldValue' => null, 'FieldType' => FulfillmentOrderItemList::className()),
    'FulfillmentShipment' => array('FieldValue' => null, 'FieldType' => FulfillmentShipmentList::className()),
    'ReturnItemList' => array('FieldValue' => null, 'FieldType' => ReturnItemList::className()),
    'ReturnAuthorizationList' => array('FieldValue' => null, 'FieldType' => ReturnAuthorizationList::className()),
    );
