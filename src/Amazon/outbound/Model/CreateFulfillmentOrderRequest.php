 ...
 */
 ...
 class CreateFulfillmentOrderRequest extends Model {
    ...
    'DeliveryWindow' => array('FieldValue' => null, 'FieldType' => DeliveryWindow::className()),
    'DestinationAddress' => array('FieldValue' => null, 'FieldType' => Address::className()),
    ...
    'CODSettings' => array('FieldValue' => null, 'FieldType' => CODSettings::className()),
    'ShipFromCountryCode' => array('FieldValue' => null, 'FieldType' => 'string'),
    'NotificationEmailList' => array('FieldValue' => null, 'FieldType' => NotificationEmailList::className()),
    'Items' => array('FieldValue' => null, 'FieldType' => CreateFulfillmentOrderItemList::className()),
    );
