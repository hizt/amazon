 ...
 */
namespace Amazon\Inbound;

use Amazon\Inbound\Model\ConfirmPreorderRequest;
use Amazon\Inbound\Model\ConfirmPreorderResponse;
use Amazon\Inbound\Model\ConfirmTransportInputRequest;
use Amazon\Inbound\Model\ConfirmTransportRequestResponse;
use Amazon\Inbound\Model\CreateInboundShipmentPlanRequest;
use Amazon\Inbound\Model\CreateInboundShipmentPlanResponse;
use Amazon\Inbound\Model\CreateInboundShipmentRequest;
use Amazon\Inbound\Model\CreateInboundShipmentResponse;
use Amazon\Inbound\Model\EstimateTransportInputRequest;
use Amazon\Inbound\Model\EstimateTransportRequestResponse;
use Amazon\Inbound\Model\GetBillOfLadingRequest;
use Amazon\Inbound\Model\GetBillOfLadingResponse;
use Amazon\Inbound\Model\GetInboundGuidanceForASINRequest;
use Amazon\Inbound\Model\GetInboundGuidanceForASINResponse;
use Amazon\Inbound\Model\GetInboundGuidanceForSKURequest;
use Amazon\Inbound\Model\GetInboundGuidanceForSKUResponse;
use Amazon\Inbound\Model\GetPackageLabelsRequest;
use Amazon\Inbound\Model\GetPackageLabelsResponse;
use Amazon\Inbound\Model\GetPalletLabelsRequest;
use Amazon\Inbound\Model\GetPalletLabelsResponse;
use Amazon\Inbound\Model\GetPreorderInfoRequest;
use Amazon\Inbound\Model\GetPreorderInfoResponse;
use Amazon\Inbound\Model\GetPrepInstructionsForASINRequest;
use Amazon\Inbound\Model\GetPrepInstructionsForASINResponse;
use Amazon\Inbound\Model\GetPrepInstructionsForSKURequest;
use Amazon\Inbound\Model\GetPrepInstructionsForSKUResponse;
use Amazon\Inbound\Model\GetServiceStatusRequest;
use Amazon\Inbound\Model\GetServiceStatusResponse;
use Amazon\Inbound\Model\GetTransportContentRequest;
use Amazon\Inbound\Model\GetTransportContentResponse;
use Amazon\Inbound\Model\GetUniquePackageLabelsRequest;
use Amazon\Inbound\Model\GetUniquePackageLabelsResponse;
use Amazon\Inbound\Model\ListInboundShipmentItemsByNextTokenRequest;
use Amazon\Inbound\Model\ListInboundShipmentItemsByNextTokenResponse;
use Amazon\Inbound\Model\ListInboundShipmentItemsRequest;
use Amazon\Inbound\Model\ListInboundShipmentItemsResponse;
use Amazon\Inbound\Model\ListInboundShipmentsByNextTokenRequest;
use Amazon\Inbound\Model\ListInboundShipmentsByNextTokenResponse;
use Amazon\Inbound\Model\ListInboundShipmentsRequest;
use Amazon\Inbound\Model\ListInboundShipmentsResponse;
use Amazon\Inbound\Model\PutTransportContentRequest;
use Amazon\Inbound\Model\PutTransportContentResponse;
use Amazon\Inbound\Model\ResponseHeaderMetadata;
use Amazon\Inbound\Model\UpdateInboundShipmentRequest;
use Amazon\Inbound\Model\UpdateInboundShipmentResponse;
use Amazon\Inbound\Model\VoidTransportInputRequest;
use Amazon\Inbound\Model\VoidTransportRequestResponse;

/**
 * FBAInboundServiceMWS_Client is an implementation of FBAInboundServiceMWS
 *
 */
class Client implements FBAInboundServiceInterface
{
