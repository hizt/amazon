...
class TransportDetailOutput extends Model
{
    ...
    {
        $this->_fields = array(
            'PartneredSmallParcelData' => array('FieldValue' => null, 'FieldType' => PartneredSmallParcelDataOutput::className()),
            'NonPartneredSmallParcelData' => array('FieldValue' => null, 'FieldType' => NonPartneredSmallParcelDataOutput::className()),
            'PartneredLtlData' => array('FieldValue' => null, 'FieldType' => PartneredLtlDataOutput::className()),
            'NonPartneredLtlData' => array('FieldValue' => null, 'FieldType' => NonPartneredLtlDataOutput::className()),
        );
     ...
     *
     * @param PartneredSmallParcelDataOutput $value
     ...
     *
     * @param NonPartneredSmallParcelDataOutput $value
     * @return this instance
     */
