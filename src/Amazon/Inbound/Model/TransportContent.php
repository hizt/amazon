...
class TransportContent extends Model
{
    ...
    {
        $this->_fields = array(
            'TransportHeader' => array('FieldValue' => null, 'FieldType' => TransportHeader::className()),
            'TransportDetails' => array('FieldValue' => null, 'FieldType' => TransportDetailOutput::className()),
