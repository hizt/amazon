...
class GetPrepInstructionsForSKUResult extends Model
{
    ...
    {
        $this->_fields = array(
            'SKUPrepInstructionsList' => array('FieldValue' => null, 'FieldType' => SKUPrepInstructionsList::className()),
            'InvalidSKUList' => array('FieldValue' => null, 'FieldType' => InvalidSKUList::className()),
        );
