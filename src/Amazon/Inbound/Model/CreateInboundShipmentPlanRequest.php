...
class CreateInboundShipmentPlanRequest extends Model
{
    ...
    public function __construct($data = null)
    {
        $this->_fields = array(
            ...
            'ShipFromAddress' => array('FieldValue' => null, 'FieldType' => Address::className()),
            ...
            'InboundShipmentPlanRequestItems' => array('FieldValue' => null, 'FieldType' => InboundShipmentPlanRequestItemList::className()),
        );
