...
class CreateInboundShipmentRequest extends Model
{
    ...
    public function __construct($data = null)
    {
        $this->_fields = array(
            ...
            'InboundShipmentHeader' => array('FieldValue' => null, 'FieldType' => InboundShipmentHeader::className()),
            'InboundShipmentItems' => array('FieldValue' => null, 'FieldType' => InboundShipmentItemList::className()),
        );
