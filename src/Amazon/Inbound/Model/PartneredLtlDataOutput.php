...
class PartneredLtlDataOutput extends Model
{
    ...
    {
        $this->_fields = array(
            'Contact' => array('FieldValue' => null, 'FieldType' => Contact::className()),
            ...
            'PalletList' => array('FieldValue' => null, 'FieldType' => PalletList::className()),
            'TotalWeight' => array('FieldValue' => null, 'FieldType' => Weight::className()),
            'SellerDeclaredValue' => array('FieldValue' => null, 'FieldType' => Amount::className()),
            'AmazonCalculatedValue' => array('FieldValue' => null, 'FieldType' => Amount::className()),
            ...
            'PartneredEstimate' => array('FieldValue' => null, 'FieldType' => PartneredEstimate::className()),
