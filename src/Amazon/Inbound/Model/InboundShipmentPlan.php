...
class InboundShipmentPlan extends Model
{
    ...
    public function __construct($data = null)
    {
        $this->_fields = array(
            ...
            'ShipToAddress' => array('FieldValue' => null, 'FieldType' => Address::className()),
            'LabelPrepType' => array('FieldValue' => null, 'FieldType' => 'string'),
            'Items' => array('FieldValue' => null, 'FieldType' => InboundShipmentPlanItemList::className()),
            'EstimatedBoxContentsFee' => array('FieldValue' => null, 'FieldType' => BoxContentsFeeDetails::className()),
        );
