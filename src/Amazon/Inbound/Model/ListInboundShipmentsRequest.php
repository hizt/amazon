...
class ListInboundShipmentsRequest extends Model
{
    ...
    public function __construct($data = null)
    {
        $this->_fields = array(
            ...
            'ShipmentStatusList' => array('FieldValue' => null, 'FieldType' => ShipmentStatusList::className()),
            'ShipmentIdList' => array('FieldValue' => null, 'FieldType' => ShipmentIdList::className()),
