...
class SKUPrepInstructions extends Model
{
    ...
    public function __construct($data = null)
    {
        $this->_fields = array(
            ...
            'PrepInstructionList' => array('FieldValue' => null, 'FieldType' => PrepInstructionList::className()),
            'AmazonPrepFeesDetailsList' => array('FieldValue' => null, 'FieldType' => AmazonPrepFeesDetailsList::className()),
        );
