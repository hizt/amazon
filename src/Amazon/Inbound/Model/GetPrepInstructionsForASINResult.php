...
class GetPrepInstructionsForASINResult extends Model
{
    ...
    {
        $this->_fields = array(
            'ASINPrepInstructionsList' => array('FieldValue' => null, 'FieldType' => ASINPrepInstructionsList::className()),
            'InvalidASINList' => array('FieldValue' => null, 'FieldType' => InvalidASINList::className()),
        );
