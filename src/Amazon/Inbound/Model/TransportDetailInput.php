...
class TransportDetailInput extends Model
{
    ...
    {
        $this->_fields = array(
            'PartneredSmallParcelData' => array('FieldValue' => null, 'FieldType' => PartneredSmallParcelDataInput::className()),
            'NonPartneredSmallParcelData' => array('FieldValue' => null, 'FieldType' => NonPartneredSmallParcelDataInput::className()),
            'PartneredLtlData' => array('FieldValue' => null, 'FieldType' => PartneredLtlDataInput::className()),
            'NonPartneredLtlData' => array('FieldValue' => null, 'FieldType' => NonPartneredLtlDataInput::className()),
        );
